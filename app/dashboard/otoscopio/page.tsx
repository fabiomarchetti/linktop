            ...
            <div className="flex items-center gap-3 lg:gap-4">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white flex items-center gap-2 lg:gap-3">
                  ...
                  <span className="hidden sm:inline">Otoscopio Digitale USB</span>
                  <span className="sm:hidden">Otoscopio USB</span>
                </h1>
                <p className="text-gray-300 text-sm lg:text-base mt-1">Esame otoscopico - Foto e video</p>
              </div>
            </div>
            {isConnected ? (
              <button onClick={stopCamera} className="px-4 py-2.5 bg-red-500/20 hover:bg-red-500/30 text-red-300 rounded-xl font-semibold transition-all border border-red-500/30 min-h-[44px] text-sm sm:text-base">Disconnetti</button>
            ) : (
              <button onClick={connectCamera} className="px-4 py-2.5 bg-gradient-to-r from-purple-500 to-indigo-600 text-white rounded-xl font-semibold flex items-center gap-2 hover:opacity-90 transition-all shadow-lg min-h-[44px] text-sm sm:text-base">
